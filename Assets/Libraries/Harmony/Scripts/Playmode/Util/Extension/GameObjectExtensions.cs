...
namespace Harmony
{
    ...
    public static class GameObjectExtensions
    {
        ...
        /// <summary>
        /// Return the specified child of the GameObject.
        /// </summary>
        public static GameObject Children(this GameObject gameObject, string name)
        {
            var transform = gameObject.transform;
            var childCount = transform.childCount;
            ...
            for (var i = 0; i < childCount; i++)
            {
                var children = transform.GetChild(i).gameObject;
