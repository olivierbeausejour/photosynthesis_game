...
namespace Harmony
{
    ...
    public static class ComponentExtensions
    {
        ...
        /// <summary>
        /// Return the specified child of the component's GameObject.
        /// </summary>
        public static GameObject Children(this Component component, string name)
        {
            return component.gameObject.Children(name);
        }
